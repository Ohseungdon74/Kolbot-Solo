...
function LoadConfig() {
	...
	*/
	...
	// 모든 영역을 지 웁니다. Config.ClearType을 사용하여 죽일 몬스터 유형을 결정합니다.
	Scripts.ClearAnyArea = false; // Clear any area. Uses Config.ClearType to determine which type of monsters to kill.
		Config.ClearAnyArea.AreaList = [12, 16, 25, 108, 131]; // List of area ids to clear. See sdk/areas.txt
	...
	// MF Switch
	Config.MFSwitchPercent = 9; // Boss life % to switch to secondary weapon slot. Set to 0 to disable.
	 ...
	 */
	Config.AttackSkill[0] = -1; // Preattack skill. Not implemented yet. //프로즌오브(기본스킬 왼쪽)
	Config.AttackSkill[1] = 64; // Primary skill to bosses. //스태틱필드
	...
	Config.AttackSkill[4] = 42; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[3] is untimed skill.
	Config.AttackSkill[5] = 47; // Secondary skill if monster is immune to primary.
